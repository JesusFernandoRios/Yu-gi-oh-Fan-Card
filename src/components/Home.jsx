    ...
    return (
        <div className="home">
            ...
            <div className="information">
                <h3>This page was created as a hobby of mine. Yu-Gi-Oh was a big deal for me in Middle School. I'd stare at my cards looking at the cards image, paying attention to all the small details. now my cards sit inside a box in my closet gathering dust. 
                </h3>
